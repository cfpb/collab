...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaggedItem.tag_creator'
        db.alter_column(u'taggit_taggeditem', 'tag_creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.CollabUser']))

    def backwards(self, orm):

        # Changing field 'TaggedItem.tag_creator'
        db.alter_column(u'taggit_taggeditem', 'tag_creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
