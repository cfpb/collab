...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MPTTComment.is_anonymous'
        db.add_column(u'custom_comments_mpttcomment', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MPTTComment.is_anonymous'
        db.delete_column(u'custom_comments_mpttcomment', 'is_anonymous')
    ...
    models = {
        ...
        u'comments.comment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comment_comments'", 'null': 'True', 'to': u"orm['core.CollabUser']"}),
        ...
        u'custom_comments.mpttcomment': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['custom_comments.MPTTComment']"}),
