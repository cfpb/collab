...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.hide_profile'
        db.add_column(u'core_person', 'hide_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.hide_profile'
        db.delete_column(u'core_person', 'hide_profile')
    ...
    models = {
        ...
        u'core.person': {
            ...
            'hide_profile': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
