...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfficeLocation.name'
        db.add_column(u'core_officelocation', 'name',
                      self.gf('django.db.models.fields.CharField')(default='default name', max_length=56),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfficeLocation.name'
        db.delete_column(u'core_officelocation', 'name')
